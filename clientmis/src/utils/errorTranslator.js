const ERROR_TRANSLATIONS = {
  ...
  'Data integrity violation': 'Невозможно выполнить операцию: данные используются в других записях',
  'Cannot delete specialty': 'Невозможно удалить специальность: есть связанные сотрудники.',
  'Cannot delete employee': 'Невозможно удалить сотрудника: есть связанные записи на приём. Используйте деактивацию.',
  'Cannot delete user': 'Невозможно удалить пользователя: есть связанные записи. Используйте деактивацию.',
  'Cannot delete service': 'Невозможно удалить услугу: есть связанные записи на приём. Используйте деактивацию.',
  'Cannot delete patient': 'Невозможно удалить пациента: есть связанные записи на приём.',
  'Deactivate instead': 'Используйте деактивацию вместо удаления.',
